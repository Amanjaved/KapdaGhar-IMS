...
export function ReceiptModal({ sale, onClose, onNewSale }: ReceiptModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm overflow-y-auto">
      <div
        className={`relative w-full ${modalContainerWidth} bg-white dark:bg-[#0f1523] border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl overflow-hidden my-auto transition-all duration-200`}
      >
        {/* Header Bar */}
        <div className="px-5 py-3.5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-[#0b0f19]/80">
          ...
          <button
            onClick={onClose}
            className="w-7 h-7 rounded-md bg-slate-200/80 hover:bg-slate-300 dark:bg-slate-800/80 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white flex items-center justify-center transition-colors"
          >
        ...
        <div className="px-5 py-2.5 bg-slate-100/70 dark:bg-[#070b12] border-b border-slate-200 dark:border-slate-800 flex items-center justify-between gap-2 text-xs">
        ...
        <div className="p-6 bg-white text-slate-900 shadow-inner" id="printable-receipt">
          {paperWidth === 'a4' ? (
        ...
        {/* Action Buttons */}
        <div className="p-4 bg-slate-50 dark:bg-[#0d1322] border-t border-slate-200 dark:border-slate-800 space-y-2 print:hidden">
