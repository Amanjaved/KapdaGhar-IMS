  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-between bg-slate-50 dark:bg-[#070b13] text-slate-900 dark:text-slate-100 p-4 sm:p-6 lg:p-8 transition-colors overflow-hidden select-none">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
              कपड़ा घर — रिटेल इन्वेंट्री & बिलिंग
            </p>
          </div>
        </div>
      ...
      <main className="relative z-10 w-full max-w-md mx-auto my-auto py-4 sm:py-6">
        <div className="bg-white/95 dark:bg-[#0d1322]/90 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/90 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-slate-900/5 dark:shadow-black/50 space-y-6">
          {/* Card Header */}
          ...
          <div className="space-y-3 pt-1">
            ...
            {errorMsg ? (
              ...
              <div className="text-center text-xs text-slate-400 dark:text-slate-500 font-medium">
                Signing in as <span className="font-semibold text-slate-700 dark:text-slate-300">{selectedStaff?.full_name || 'Staff'}</span>
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-3 gap-2.5 pt-1">
            {[
              ...
              <button
                ...
                className="h-14 sm:h-15 rounded-2xl bg-slate-100/90 hover:bg-indigo-50/80 active:bg-indigo-100 dark:bg-slate-800/70 dark:hover:bg-indigo-950/40 dark:active:bg-indigo-900/60 text-slate-800 dark:text-slate-100 transition-all duration-150 active:scale-95 border border-slate-200/70 dark:border-slate-700/50 shadow-xs flex flex-col items-center justify-center cursor-pointer select-none"
              >
      ...
      <footer className="relative z-10 w-full max-w-md mx-auto text-center space-y-1">
        <div className="inline-flex items-center gap-1.5 text-slate-400 dark:text-slate-500 text-xs">
          ...
          <span>Encrypted Shift Access • Retail POS Terminal</span>
        </div>
      </footer>
    </div>
  );
